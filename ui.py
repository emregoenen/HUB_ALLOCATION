...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_11.addWidget(self.textBrowser_infoPanel)
        self.textBrowser_infoPanel_final = QtWidgets.QTextBrowser(self.groupBox_8)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.textBrowser_infoPanel_final.sizePolicy().hasHeightForWidth())
        self.textBrowser_infoPanel_final.setSizePolicy(sizePolicy)
        self.textBrowser_infoPanel_final.setMaximumSize(QtCore.QSize(16777215, 200))
        self.textBrowser_infoPanel_final.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.textBrowser_infoPanel_final.setObjectName("textBrowser_infoPanel_final")
        self.horizontalLayout_11.addWidget(self.textBrowser_infoPanel_final)
